      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          for (var doc in snapshot.data!.docs) {
            ...
            var milkDailyTasks = List<int>.from(data['gheeDailyTasks'] ?? []);
            var milkDailyQuantity = data['gheeDailyQuantity'] ?? 0;
            var milkDailyAmount = data['gheeDailyAmount'] ?? 0;
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 10),
                    Text(
                      'Ghee Quantity: $milkDailyQuantity',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                        color: theme.tertiary,
